                            ...
                            <div class="qvx">
                                <div class="image-block large-image col_large_default avalible">
                                    <div class="view_full_size">
                                        <a href="#">
                                            <img src="../image/Lựu.jpg" alt="" class="img-product">
                                        </a>
                                    </div>
                                    <div class="list_view_full_size">
                                        <div><img src="../image/Lựu.jpg" alt=""></div>
                                        <div><img src="./Lựu/luu.png" alt=""></div>
                                        <div><img src="./Lựu/qua-luu-ngon.jpg" alt=""></div>
                                        <div><img src="./Lựu/qua-luu.jpg" alt=""></div>
                                        <div><img src="./Lựu/qua-luu1.png" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
