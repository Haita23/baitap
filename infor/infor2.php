                            ...
                            <div class="qvx">
                                <div class="image-block large-image col_large_default avalible">
                                    <div class="view_full_size">
                                        <a href="#">
                                            <img src="../image/Sầu_riêng.png" alt="" class="img-product">
                                        </a>
                                    </div>
                                    <div class="list_view_full_size">
                                        <div><img src="../image/Sầu_riêng.png" alt=""></div>
                                        <div><img src="./Sầu riêng/66573.jpg" alt=""></div>
                                        <div><img src="./Sầu riêng/sau_rieng.png" alt=""></div>
                                        <div><img src="./Sầu riêng/sauRieng.png" alt=""></div>
                                        <div><img src="./Sầu riêng/saurieng1.png" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
