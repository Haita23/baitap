                            ...
                            <div class="qvx">
                                <div class="image-block large-image col_large_default avalible">
                                    <div class="view_full_size">
                                        <a href="#">
                                            <img src="../image/Ổi.jpg" alt="" class="img-product">
                                        </a>
                                    </div>
                                    <div class="list_view_full_size">
                                        <div><img src="../image/Ổi.jpg" alt=""></div>
                                        <div><img src="./Ổi/0-1200x676-14.jpg" alt=""></div>
                                        <div><img src="./Ổi/cay-oi.jpg" alt=""></div>
                                        <div><img src="./Ổi/qua oi 4.jpg" alt=""></div>
                                        <div><img src="./Ổi/ổi1.jpg" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
