                            ...
                            <div class="qvx">
                                <div class="image-block large-image col_large_default avalible">
                                    <div class="view_full_size">
                                        <a href="#">
                                            <img src="../image/Muối_tôm.png" alt="" class="img-product">
                                        </a>
                                    </div>
                                    <div class="list_view_full_size">
                                        <div><img src="../image/Muối_tôm.png" alt=""></div>
                                        <div><img src="./Muối tôm Như Ý/tải xuống (1).png" alt=""></div>
                                        <div><img src="./Muối tôm Như Ý/tải xuống.png" alt=""></div>
                                        <div><img src="./Muối tôm Như Ý/muoi-tom-nhu-y-1.jpg" alt=""></div>
                                        <div><img src="./Muối tôm Như Ý/Muoitomnhuy2.jpg" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
