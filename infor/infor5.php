                            ...
                            <div class="qvx">
                                <div class="image-block large-image col_large_default avalible">
                                    <div class="view_full_size">
                                        <a href="#">
                                            <img src="../image/cam.png" alt="" class="img-product">
                                        </a>
                                    </div>
                                    <div class="list_view_full_size">
                                        <div><img src="../image/cam.png" alt=""></div>
                                        <div><img src="./Cam/cam-.png" alt=""></div>
                                        <div><img src="./Cam/cam-ruot-do.jpg" alt=""></div>
                                        <div><img src="./Cam/cam.jpg" alt=""></div>
                                        <div><img src="./Cam/qua-cam.jpg" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
