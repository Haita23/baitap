    ...
    <div id="quick-review">
        <div class="fruild-container">
            <div class="quick-view-product"
                ...
                <div
                    class="block-quickview primary_block details-product">

                    <div class="row">
                        <div
                            class="product-left-column product-images col-xs-12 col-sm-4 col-md-4 col-lg-6 col-xl-6">
                            <div class="qvx">
                                <h1 name="tensp">Nho Mỹ</h1>
                                <div
                                    class="image-block large-image col_large_default avalible">
                                    <div class="view_full_size">
                                        <a href="#">
                                            <img src="../image/Nho_Mỹ.png"
                                                alt=""
                                                class="img-product">
                                        </a>
                                    </div>
                                    <div
                                        class="list_view_full_size">
                                        <div><img
                                                src="../image/Nho_Mỹ.png"
                                                alt=""></div>
                                        <div><img
                                                src="./Nho/nho-xanh-my-0-442-cp.png"
                                                alt=""></div>
                                        <div><img
                                                src="./Nho/nho_den.jpg"
                                                alt=""></div>
                                        <div><img
                                                src="./Nho/qua-nho11.jpg"
                                                alt=""></div>
                                        <div><img
                                                src="./Nho/trai-nho.jpg"
                                                alt=""></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="infor">
                                ...
                                <form action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p name="gia">300.000</p>
                                    </div>
     
                                    <input type="submit"
                                            class="btn btn-default" name="addcart" value="Mua ngay">
                                </form>
                            </div>
