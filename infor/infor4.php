                            ...
                            <div class="qvx">
                                <div class="image-block large-image col_large_default avalible">
                                    <div class="view_full_size">
                                        <a href="#">
                                            <img src="../image/Chery_Mỹ.png" alt="" class="img-product">
                                        </a>
                                    </div>
                                    <div class="list_view_full_size">
                                        <div><img src="../image/Chery_Mỹ.png" alt=""></div>
                                        <div><img src="./Chery Mỹ/cherry-my.jpg" alt=""></div>
                                        <div><img src="./Chery Mỹ/cherry.jpg" alt=""></div>
                                        <div><img src="./Chery Mỹ/chery-bbg.png" alt=""></div>
                                        <div><img src="./Chery Mỹ/gia-cherry.png" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
