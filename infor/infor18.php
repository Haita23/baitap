                            ...
                            <div class="qvx">
                                <div class="image-block large-image col_large_default avalible">
                                    <div class="view_full_size">
                                        <a href="#">
                                            <img src="../image/Ajinomoto.png" alt="" class="img-product">
                                        </a>
                                    </div>
                                    <div class="list_view_full_size">
                                        <div><img src="../image/Ajinomoto.png" alt=""></div>
                                        <div><img src="./Bột ngọt Ajinomoto/ajinomoto.jpg" alt=""></div>
                                        <div><img src="./Bột ngọt Ajinomoto/1635752660_Untitled-1-01.jpg" alt=""></div>
                                        <div><img src="./Bột ngọt Ajinomoto/bot-ngot-ajinomoto-400g.jpg" alt=""></div>
                                        <div><img src="./Bột ngọt Ajinomoto/bot-ngot-ajinomoto.jpg" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
