                            ...
                            <div class="qvx">
                                <div class="image-block large-image col_large_default avalible">
                                    <div class="view_full_size">
                                        <a href="#">
                                            <img src="../image/đu_đủ.jpg" alt="" class="img-product">
                                        </a>
                                    </div>
                                    <div class="list_view_full_size">
                                        <div><img src="../image/đu_đủ.jpg" alt=""></div>
                                        <div><img src="./Đu đủ/du-du(1).jpg" alt=""></div>
                                        <div><img src="./Đu đủ/du-du-chin.jpg" alt=""></div>
                                        <div><img src="./Đu đủ/đu-đu.jpg" alt=""></div>
                                        <div><img src="./Đu đủ/đu_đủ.png" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
